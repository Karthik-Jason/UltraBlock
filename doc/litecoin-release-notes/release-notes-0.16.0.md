...
### BIP173 (Bech32) Address support ("utl1..." addresses)
...
* A new field `iswitness` is True for P2WPKH and P2WSH addresses ("utl1..." addresses), but not for P2SH-wrapped segwit addresses (see below).
