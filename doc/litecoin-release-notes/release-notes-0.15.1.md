...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 blessings per kB (0.00001 UTL). This is to prepare for dropping the minimum transaction fee to 0.1 blessings per kB (0.0001 UTL) in the next release.
